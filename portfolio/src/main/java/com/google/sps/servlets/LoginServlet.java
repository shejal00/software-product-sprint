...
import com.google.sps.data.Authorization;
...
public class LoginServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Authorization authorization = new Authorization(checkLoggedIn, redirectToThisUrl);
        response.getWriter().println(gson.toJson(authorization));
    }
}
